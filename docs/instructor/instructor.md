...
| - | - | - | - |
| MySQL Linux | db-linux | Rocky 9.1 | 172.31.32.35 |
| Web-Server Linux | web-linux | Rocky 9.1 | 172.31.32.30 |
...
| RDS | RDS server for some secrets demos | Windows 2016 | 172.31.32.25 |
...
| HSPAS | Windows platform for the Cloud tenant | Windows 2016 | 172.31.32.200 |
